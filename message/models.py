...
class Message(models.Model):
    ...
    from_user = models.ForeignKey(User, verbose_name=_l('from user'), null=False, blank=False,
                                  related_name='messages')
    to_user = models.ForeignKey(User, verbose_name=_l('to user'), null=False, blank=False, related_name='messages')
    ...
    solver = models.ForeignKey(User, verbose_name=_l('solver'), null=True, blank=True, related_name='messages')
